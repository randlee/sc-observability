...
- a required fenced JSON handoff from the initial plan-author guidelines pass
...
Reject the task if the fenced JSON handoff from the initial plan-author
...
- `FAIL` if the fenced JSON handoff from the initial plan-author guidelines
