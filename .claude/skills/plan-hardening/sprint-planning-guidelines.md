...
developer pool (`cobs`, `aobs`, `lobs`) based on task fit: deep-reasoning for
algorithmic, architectural, or performance work; fast for bounded or
documentation work. They are advice, not an assignment.
