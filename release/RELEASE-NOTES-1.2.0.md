...
- The Phase B typed error methods and migration-warning rollout are proposed
  follow-on work, not part of the v1.2.0 publication; no legacy removal schedule
  or major-release claim is made.
