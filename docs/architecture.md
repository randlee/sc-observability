...
The [CI policy](ci-policy.md) keeps semver strict on every PR. Scoped API
approvals are strict for PR bases `develop` and `main`; all other bases
receive approval warnings, a diff summary and artifacts in report mode.
