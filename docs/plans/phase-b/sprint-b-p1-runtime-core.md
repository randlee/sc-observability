...
[runtime contract](runtime-level-contract.md). Public-API review status stays
proposed; historical QA verdicts remain unchanged. Final closeout QA is pending.
